...
if (token) {
  ...
  return (
    <div className="register">
        <span className="registertitle">Register Alunmni </span>
  ...
  <div class="form-group">
  <label for="visibilite">Haw do you want to set the visibility of your account </label>
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-controlp" id="password" name="password" required onChange={e=>setPassword(e.target.value)}/>
  </div>
